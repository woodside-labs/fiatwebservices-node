...
```sh
npm install git+ssh://git@github.com:stainless-sdks/fiatwebservices-typescript.git
```
...
1. Via the `FIATWEBSERVICES_LOG` environment variable
...
const client = new Fiatwebservices({
  logger: logger.child({ name: 'Fiatwebservices' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/fiatwebservices-typescript/issues) with questions, bugs, or suggestions.
