import fs from 'fs';
import type { ResponseLike } from 'fiatwebservices/internal/to-file';
import { toFile } from 'fiatwebservices/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('fiatwebservices/core/uploads');
    await expect(
