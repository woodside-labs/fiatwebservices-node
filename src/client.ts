...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['FIATWEBSERVICES_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['FIATWEBSERVICES_LOG'] or 'warn' if it isn't set.
   */
...
export class Fiatwebservices {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Fiatwebservices.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('FIATWEBSERVICES_LOG'), "process.env['FIATWEBSERVICES_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('FIATWEBSERVICES_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.fiatwebservices.com';
  }
  ...
  static Fiatwebservices = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static FiatwebservicesError = Errors.FiatwebservicesError;
